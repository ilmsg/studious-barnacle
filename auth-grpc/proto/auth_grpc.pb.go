...
func (c *authClient) Register(ctx context.Context, in *RegisterRequest, opts ...grpc.CallOption) (*LoginResponse, error) {
...
func (UnimplementedAuthServer) Register(context.Context, *RegisterRequest) (*LoginResponse, error) {
